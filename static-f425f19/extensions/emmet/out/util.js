...
function toLSTextDocument(doc) {
    return vscode_html_languageservice_1.TextDocument.create(doc.uri.toString(), doc.languageId, doc.version, doc.getText());
}
