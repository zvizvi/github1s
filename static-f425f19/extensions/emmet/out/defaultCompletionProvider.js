...
class DefaultCompletionItemProvider {
    ...
    provideCompletionItemsInternal(document, position, context) {
        ...
        if (validateLocation && !abbreviationActions_1.isValidLocationForEmmetAbbreviation(document, rootNode, currentNode, syntax, position, toRange(extractAbbreviationResults.abbreviationRange))) {
            return;
        }
